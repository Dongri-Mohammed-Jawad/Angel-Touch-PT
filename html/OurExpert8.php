...
<html>
<head>
    <title>Angel Touch Physical Therapy | Our Expert Wasif Muhammed</title>
    <meta charset="utf-8">
...
<?php include("Header.php"); ?>
    ...
    <section id="section-title" class="bg-alternative">
        <div id="top-img-bg">
            <h1 class="text-center">Asif Qazi, Marketing Manager</h1>
        </div>
    </section>
    <!-- End Section Title -->
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-6 col-md-6 col-sm-6">
                        <img src="assets/img/people/avatar1.png" class="img-responsive" alt="blog1" title="Angel Touch Physical Therapy Image." />
                    </div>
                    <div class="col-xs-12 col-lg-6 col-md-6 col-sm-6">
                        <h3 class="uppercase">Our Expert Asif Qazi</h3>
                        <div class="vs-20"></div>
                        <p>
                            Asif has an outgoing, gregarious, and spontaneous nature. He wants to make a difference in the community and get people back to doing the things they love and want to do! A leader, providing great care and adding another positive personality to our team! 
                        </p>
                        <p>
