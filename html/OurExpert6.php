...
<html>
<head>
    <title>Angel Touch Physical Therapy | Our Expert Geoffrey Gabaud PT Aide</title>
    <meta charset="utf-8">
...
<?php include("Header.php"); ?>
    ...
    <section id="section-title" class="bg-alternative">
        <div id="top-img-bg">
            <h1 class="text-center">Geoffrey Gabaud PT Aide</h1>
        </div>
    </section>
    <!-- End Section Title -->
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-6 col-md-6 col-sm-6">
                        <img src="assets/img/people/avatar2.png" class="img-responsive" alt="blog1" title="Angel Touch Physical Therapy Image." />
                    </div>
                    <div class="col-xs-12 col-lg-6 col-md-6 col-sm-6">
                        <h3 class="uppercase">Our Expert Geoffrey Gabaud PT Aide</h3>
                        <div class="vs-20"></div>
                        <p>
                            Geoffrey is personable, reliable, professional, and efficient for our fast-paced physical therapy office. Experienced as a PT aide, he is eager to learn innovative techniques and to gain hands-on experience in direct patient care.
